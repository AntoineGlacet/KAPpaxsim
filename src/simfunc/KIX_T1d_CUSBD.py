...
def KIX_T1_CUSBD_departure_sim_function(
    ...
    df_Pax,
    df_Counters,
    Pt_checkin_1step_counter=150,
    Pt_checkin_2step_counter=90,
    N_kiosk=92,
    Pt_kiosk=90,
    N_CUSBD=24,
    ...
    class departure_creator(object):
        ...
        def __init__(
            ...
            self.dummy_machine3 = simpy.Resource(env, 9999999999999999999999999)
...
def univariate_cost_function_generator_t1d_CUSBD_N(
    ...
    def cost_function_t1d_CUSBD_N(
        ...
        (
            ...
            dct_hist_wait_time,
            dct_hist_queue_length,
        ) = KIX_T1_CUSBD_departure_sim_function(**dct_param_T1d)
